// pages/recipe/components/NutritionalInfo.jsx
...
const NutritionalInfo = ({ nutritionalInfo }) => {
    ...
    //  Ahora los datos vienen con los nombres correctos desde el hook
    const items = [
        { 
            icon: <Flame size={18} />, 
            label: 'Calorías', 
    ...
    // Extraer número para la barra de progreso
    ...
    return (
        ...
        >
            <Title order={3} mb="md" style={{ color: 'var(--text-h)' }}>
